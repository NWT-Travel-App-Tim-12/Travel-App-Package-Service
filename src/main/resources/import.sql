...
insert into regions ("name", notes, currency_ref_id, super_region_id) values ('Bosnia', 'Urban region', 1, null), ('Kakanj', 'Mountains', 1, 1), ('France', 'Europe', 3, null), ('Paris', 'City', 1, 3);

insert into packages (agency, agent_ref, created_at, description, "name", package_code, valid_from, valid_to, region_ref_id) values (uuid_generate_v4(), 1, NOW(), 'Travel to Paris', 'Paris travel', 'PT123', TO_DATE('2023-03-03', 'YYYY-MM-DD'), TO_DATE('2023-12-03', 'YYYY-MM-DD'), 3), (uuid_generate_v4(), 1, NOW(), 'Travel to Kakanj', 'Kakanj travel', 'KT123', TO_DATE('2023-03-03', 'YYYY-MM-DD'), TO_DATE('2023-12-03', 'YYYY-MM-DD'), 1);
