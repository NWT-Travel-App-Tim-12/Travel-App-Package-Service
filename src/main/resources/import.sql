...
insert into packages (agency, agent_ref, created_at, description, "name", package_code, valid_from, valid_to, region_id) values ('64da5ad1-b828-4987-86af-c4d38ec21a33', 1, NOW(), 'Travel to Paris', 'Paris travel', 'PT123', TO_DATE('2023-03-03', 'YYYY-MM-DD'), TO_DATE('2023-12-03', 'YYYY-MM-DD'), 3), ('35307f4e-4dc7-4493-bdf4-2d1a9b115fd7', 1, NOW(), 'Travel to Kakanj', 'Kakanj travel', 'KT123', TO_DATE('2023-03-03', 'YYYY-MM-DD'), TO_DATE('2023-12-03', 'YYYY-MM-DD'), 1);
